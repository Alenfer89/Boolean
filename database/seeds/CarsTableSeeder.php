...
class CarsTableSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        for($i= 0; $i < 50; $i++){
            ...
            $car->model = ucfirst($faker->randomElement(['twingo','megane','clio','capture','kadjar', 'ax','ds 4','c2','c3','c4','impala','fiesta','focus','mondeo','puma','ghibli','levante','grecale','Quattroporte GT','h1','h2','h3']));
