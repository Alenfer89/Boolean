...
$faqs=[
    ...
    [
        ...
        <li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol></p>
    ...
    <div class="container">
        <?php foreach($faqs as $module){ ; ?>
            <h3><?php echo $module['question'] ; ?></h3>
                <?php echo $module['answer'] ; ?>
        <?php } ; ?>
    </div>
    <div class="container">
        <?php foreach($otherFaqs as $question => $answer){ ; ?>
            <h3><?php echo $question ; ?></h3>
            <?php foreach(explode('||', $answer) as $paragraph){ ; ?>
